...
class CalculatorState extends State<Calculator> {
  ...
  void insertData(Equation, Result) {
    LocalDatabase().addDataLocally(Equation: Equation, Result: Result);
  }
  ...
  void equalPressed() {
    ...
    if (result == 'Infinity' || result == 'NaN' || result == '-Infinity') {
      insertData(equation, "Can not divide by 0");
      result = 'Can not divide by 0';
      equation = '';
    } else if (result == '-0.0' || result == '0.0' || result == '0') {
      insertData(equation, "0");
      result = '0';
      equation = '';
    } else {
      insertData(equation, result);
      result;
      equation = result;
    }
  }
  ...
  Future<void> _historyDialog(int len) async {
      ...
      builder: (BuildContext context) {
        return MaterialApp(
          home: SingleChildScrollView(
            child: Container(
              margin: const EdgeInsets.only(top: 65, left: 13, right: 13),
              child: SizedBox(
                height: 300,
                child: Container(
                  decoration: BoxDecoration(
